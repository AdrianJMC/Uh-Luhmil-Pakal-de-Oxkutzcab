...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('css/admin-custom.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('css/Diseño-Index-Create-Edit.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('css/Gestion-de-usuarios.css') }}">
