...
<head>
    ...
    <title>@yield('title', 'Dashboard de Agrupaciones')</title>
    ...
    <link rel="stylesheet" href="@assetAuto('css/Gestion-de-Perfiles.css')">
    <link rel="stylesheet" href="@assetAuto('css/gestor-agrupaciones.css')">
    <link rel="stylesheet" href="@assetAuto('css/Dashboard-agrupaciones/Sidebar.css')">
    <link rel="stylesheet" href="@assetAuto('css/Dashboard-agrupaciones/Page-MisProductos.css')">
    <link rel="stylesheet" href="@assetAuto('css/Dashboard-agrupaciones/page-crearProducto.css')">
    <link rel="stylesheet" href="@assetAuto('css/Dashboard-agrupaciones/page-pedidos.css')">
    <link rel="stylesheet" href="@assetAuto('css/Dashboard-agrupaciones/dashboard.css')">
