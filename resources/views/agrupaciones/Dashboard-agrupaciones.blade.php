@extends('layouts.agrupaciones') {{-- O tu layout para agrupaciones --}}
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="pagination pagination-sm">
                                    <li class="page-item"><a href="{{ url('#') }}" class="page-link">&laquo;</a>
                                    </li>
                                    <li class="page-item"><a href="{{ url('#') }}" class="page-link">1</a></li>
                                    <li class="page-item"><a href="{{ url('#') }}" class="page-link">2</a></li>
                                    <li class="page-item"><a href="{{ url('#') }}" class="page-link">3</a></li>
                                    <li class="page-item"><a href="{{ url('#') }}" class="page-link">&raquo;</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="card-tools">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a href="{{ url('#') }}" class="dropdown-item">Add new event</a>
                                        <a href="{{ url('#') }}" class="dropdown-item">Clear events</a>
                                        <div class="dropdown-divider"></div>
                                        <a href="{{ url('#') }}" class="dropdown-item">View calendar</a>
                                    </div>
                                </div>
